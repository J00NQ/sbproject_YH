...
public class PostsApiControllerTest {
        ...
        public void Posts_수정된다() {
                ...
                com.jojoldu.book.springboot.web.dto.PostsUpdateRequestDto requestDto = PostsUpdateRequestDto.builder()
                ...
                ResponseEntity<Long> responseEntity = restTemplate.exchange(url,
                                ...
                                new org.springframework.http.HttpEntity<>(requestDto), Long.class);
                // then
                assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
                assertThat(responseEntity.getBody()).isGreaterThan(0L);
                List<Posts> all = postsRepository.findAll();
